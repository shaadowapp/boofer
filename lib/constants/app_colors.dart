...
class AppColors {
  ...
  static const Color loveRose =
      Color(0xFF5865F2); // Trial brand color - Discord-like blue
  static const Color deepBlush =
      Color(0xFF4752C4); // Deeper variant of brand color
  static const Color trustBlue =
      Color(0xFF2196F3); // Security blue - privacy indicators
  static const Color secretGreen =
      Color(0xFF00C853); // Encrypted green - secure status

  // Light Mode Colors - Clean & Minimal Theme
  static const Color lightBackground =
      Color(0xFFF9F9F9); // Very light grey background
  ...
  static const Color lightSenderBubble =
      Color(0xFFE8EAFF); // Light blue - your messages (complements #5865f2)
  static const Color lightReceiverBubble =
      Color(0xFFF0F0F0); // Soft grey - partner's messages
  static const Color lightPrimaryText = Color(0xFF2C2C2C); // Warm dark grey
  static const Color lightSecondaryText =
      Color(0xFF757575); // Medium grey for timestamps
  ...
  static const Color darkSenderBubble =
      Color(0xFF2C3A7A); // Dark blue variant - your messages
  static const Color darkReceiverBubble =
      Color(0xFF2C2C2C); // Dark grey - partner's messages
  static const Color darkPrimaryText = Color(0xFFFFFFFF); // Pure white text
  static const Color darkSecondaryText =
      Color(0xFFB0B0B0); // Light grey for timestamps
  ...
  static const Color heartReaction =
      loveRose; // Blue for likes/hearts (trial color)
  static const Color disappearingMessage =
      Color(0xFFFF9800); // Orange for disappearing messages

  // Privacy & Security Indicators
  static const Color privateMode =
      Color(0xFF6A1B9A); // Deep purple for private mode
  static const Color secureConnection = trustBlue; // Blue for secure connection
  static const Color biometricLock =
      Color(0xFF4CAF50); // Green for biometric security

  // Floating Action Button - Heart-themed
  static Color floatingActionButton(bool isDark) =>
      isDark ? deepBlush : loveRose;
  ...
  static Color searchBarColor(bool isDark) =>
  ...
  static Color senderBubble(bool isDark) =>
      isDark ? darkSenderBubble : lightSenderBubble;
...
extension AppColorExtensions on Color {
  ...
  Color get withRomanticAccent =>
      Color.lerp(this, AppColors.loveRose, 0.1) ?? this;

  /// Creates a secure trust overlay for privacy elements
  Color get withTrustAccent =>
      Color.lerp(this, AppColors.trustBlue, 0.1) ?? this;
